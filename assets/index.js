import {Financiamento, FinanciamentoComCarencia} from './financiamento.js'
...
botaoCalcular.addEventListener('click',function(){
    ...
    if(comCarencia.checked){
        const carencia = parseFloat(listaSuspensa.value);
        simulacao = new FinanciamentoComCarencia(valor,entrada,taxaJuros,prazo, carencia);
    } else{
